...
INFO = Gauge("fastapi_app_info", "FashAPI application infomation.", ["app_name"])

REQUESTS = Counter(
    "fastapi_requests_total",
    "Total count of request by method and path.",["method", "path", "app_name"],
)
...
REQUESTS_PROCESSING_TIME = Histogram(
    ...
    "Histogram of requests progressing time by path",
    ["method", "path", "app_name"],
)

EXCEPTIONS = Counter(
    "fastapi_exceptions_total",
    "Total count of exceptions",
    ["methods", "path", "exception_type", "app_name"],
)

REQUESTS_IN_PROGRESS = Gauge(
    "fastapi_requests_in_progress", "Guage of request",["method", "path", "app_name"]
)
...
trace._set_tracer_provider(tracer)
